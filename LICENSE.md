...
* Can be used in any number of projects under single domain; it includes sub domains also
   for instance, a licence key purchased, could be used for example.com and blog.example.com
* Commercial use allowed complying with license terms
* Cannot modify source-code for any purpose (cannot create derivative works)

Additional Terms:
* Free for personal use and for non-profit organiztaions
* Free to use and test in non-production servers. For example, dev.example.com & test.example.com
* The license key should be present at the top of TimeOnSite Tracker(timeonsitetracker.js) file
* Key should be present in source file like,

 {License key: 0340832640346853-example.com-2348294082340234}
...
Preamble: This Agreement, signed on Dec 1, 2016 (hereinafter: Effective Date) governs the relationship between Saleem Khan, a Business Entity, (hereinafter: Licensee) and TimeOnSite Tracker, a private person whose principal place of business is Chennai, India. (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using TimeOnSite Tracker (hereinafter: The Software) created and owned by Licensor, as detailed herein
